...
START TRANSACTION;
USE `biomedb`;
INSERT INTO `sighting` (`id`, `date_posted`, `description`, `location`, `image`, `user_id`, `plant_id`, `latitude`, `longitude`) VALUES (1, '2022-12-22 00:00:00', 'This sure is a plant', 'Somewhere', NULL, 1, 1, NULL, NULL);
