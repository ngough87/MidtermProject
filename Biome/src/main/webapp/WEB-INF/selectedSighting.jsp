...
<div class="row h-100 justify-content-center align-items-center ">
		<div class="card" style="max-width: 900px; margin: 100px;">
			...
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item" >Created By: <a href = "selectedUser.do?id=${sighting.user.id}"> ${sighting.user.username} </a></li>
				...
				<li class="list-group-item">Date Posted:  ${sighting.datePosted.dayOfMonth} ${sighting.datePosted.month} ${sighting.datePosted.year}</li>
				...
				<div style="float: left;">
					<form action="allSightings.do" >
						...
						<button class="btn btn-info btn-md" type="submit"
							value="Return to All Plants" id="btn1">Return to All Plants Sightings</button>
			...
			<div class="card-body">
				...
				<div class="d-flex">
				<textarea name="contents" rows="5" style="width: 100%; max-width: 100%;" placeholder="Enter comment here" >  </textarea>
				</div>
				<br>
				<div>
			...
			<tbody>
					...
					<tr>	
					<td class="comments"><font size="2">  ${comment.datePosted.dayOfMonth} ${comment.datePosted.month} ${comment.datePosted.year}</font></td>	
					
					<td> <a href="selectedUser.do?id=${sighting.user.id}">${comment.user.username}</a></td>
